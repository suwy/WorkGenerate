...
public class FreeMarkerImpl implements TemplateEngine {
    ...
    public void processToFile(Map<String, Object> model, TemplateElement templateElement)
        ...
        try {
            ...
            System.out.println("输出templateElement.getTemplateFile()="+templateElement.getTemplateFile());
            ...
            if(templateElement.getTemplateFile().contains("Select")) {
                targetFileName = "Get"+targetFileName;
            }
            if(templateElement.getTemplateFile().contains("Delete")) {
                targetFileName = "Delete"+targetFileName;
            }
            if(templateElement.getTemplateFile().contains("Update")) {
                targetFileName = "Update"+targetFileName;
            }
