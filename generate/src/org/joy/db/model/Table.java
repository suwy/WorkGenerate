...
public class Table implements java.io.Serializable {
    ...
    public void setTableAlias(String tableAlias, String desc) {
        this.tableAlias = tableAlias;
        this.className = tableAlias;//StringUtil.getCamelCaseString(tableAlias, true);
        this.javaProperty = StringUtil.lowerCaseFirst(tableAlias);
        this.desc = desc;
    }
